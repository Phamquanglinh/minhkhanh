...
<li class="nav-item text-white"><a class="nav-link" href="{{ backpack_url('dashboard') }}"><i
            class="la la-home nav-icon"></i> {{ trans('backpack::base.dashboard') }}</a></li>
<li class="nav-title bg-gray-400 text-danger">Sản phẩm</li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('trade') }}'><i class='nav-icon la la-trademark'></i> Nhà
        phân phối</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('category') }}'><i class='nav-icon la la-book'></i> Danh
        mục</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('products') }}'><i class='nav-icon la la-box'></i> Sản
        phẩm</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('tag') }}'><i class='nav-icon la la-tags'></i> Nhãn</a>
</li>
